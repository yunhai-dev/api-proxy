    ...
    <div className="settings-panel">
      ...
      <div className="settings-grid">
        ...
        <div className="settings-card wide" hidden={activeTab !== "notifications"}>
          ...
          <div className="field mb-3"><label>事件通知冷却（分钟）</label><input className="mono" type="number" min={0} max={1440} step={1} value={settings.platformIncidentCooldownMinutes} onChange={e => setSettings({ ...settings, platformIncidentCooldownMinutes: Number(e.target.value) })} /><div className="hint">同一事件的告警与恢复共享冷却窗口；0 表示关闭冷却。</div></div>
