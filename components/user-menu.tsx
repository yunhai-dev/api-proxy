...
export function UserMenu({ label }: { label: string }) {
  ...
  return (
    <details className="relative" ref={detailsRef}>
      <summary className="flex cursor-pointer list-none items-center gap-2 rounded-md px-2 py-1.5 text-sm hover:bg-muted hover:text-foreground">
      ...
      <div className="absolute right-0 top-full z-50 mt-2 grid min-w-36 gap-1 rounded-md border bg-popover p-1 text-popover-foreground shadow-md">
