...
export async function PATCH(req: NextRequest) {
  ...
  const settings = await updateSettingsAsync({
    ...
    claudeFallbackEnabled: typeof body.claudeFallbackEnabled === "boolean" ? body.claudeFallbackEnabled : undefined,
    claudeFallbackChannelId: typeof body.claudeFallbackChannelId === "string" ? body.claudeFallbackChannelId.trim() : undefined,
    claudeFallbackModel: typeof body.claudeFallbackModel === "string" ? body.claudeFallbackModel.trim() : undefined,
    openaiFallbackEnabled: typeof body.openaiFallbackEnabled === "boolean" ? body.openaiFallbackEnabled : undefined,
    openaiFallbackChannelId: typeof body.openaiFallbackChannelId === "string" ? body.openaiFallbackChannelId.trim() : undefined,
    openaiFallbackModel: typeof body.openaiFallbackModel === "string" ? body.openaiFallbackModel.trim() : undefined,
